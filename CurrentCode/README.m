% This is a random dots paradigm created by Maria Mckinley at the
% University of Washington, modified significantly by Aly Shakoor for use at the
% University of Georgia in the Sensorimotor Neuroscience Laboratory under
% the direction of Dr. Tarkesh Singh.
% 
% Specifics about the paradigm are below from the original README file.
% For our purposes, the files of interest are:
% 
% 1) dotTrial.m --- this file contains most of the parameters,
%   including the sets of coherence, dot direction, and aperture velocity.
%   This file should be run.
% 
% 2) createDotInfo.m --- used by dotTrial to return dotInfo struct.
%   Contains some secondary parameters like dot speed, aperature size, etc.
% 
% 3) dotsX.m --- takes in dotInfo struct for parameters and contains most
%   of the actual drawing/graphical code. Returns an output struct.
% 
% 4) singleDot.m --- parameters/drawing code for single dot traversal
% 
% 5) output.m --- pass in outputStruct array (returned by dotsX) to fill csv's. 
%  **NOTE: Please update the folder paths in this file to your liking.
% 
% 6) helper files like presentFeedback.m, openExperiment.m, 
%   closeExperiment.m, whiteSquareFlash.m
% 
% NOTE ABOUT WHITE SQUARE FLASH: code for this can be found in
% Sections 1 and 3.5 of dotsX.m and in whiteSquareFlash.m 
% The purpose of this flash is to signal
% to the event listener used at the MEG in Coverdell. You may have to mess
% with the size/duration of the flash, which can be changed in the file
% whiteSquareFlash.m
%
% Aly Shakoor
% Updated May 2019
